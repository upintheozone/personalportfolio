        ...
        <div className={styles['hero-content']} id="hero-content">
          <div className={styles['hero-center']}>
            ...
            <motion.div initial={"hidden"} animate={"show"} variants={bodyText}>
              ...
              <p>I've worked on a variety of aspiring and innovative <span className={styles['hero-emphasis']}>💡 projects</span> with my peers within and outside the school environment. I focus on projects that I strongly believe will <span className={styles['hero-emphasis']}>⚙️ change ️the world</span> and inspire a <span className={styles['hero-emphasis']}>🔆 bright future</span> ahead. </p>
